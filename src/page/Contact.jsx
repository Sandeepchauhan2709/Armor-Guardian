...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      'service_zecd0qo', // Create this in EmailJS dashboard
      'template_zdxqrni', // Create this in EmailJS dashboard
      templateParams,
      'eEg7aSMy09kKt3V2P' // Get this from EmailJS dashboard
    )
    .then((response) => {
                ...
                <div className="space-y-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">Arjunganj, Lucknow, Uttar Pradesh - 226002</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">+91 8707616261</p>
                    </div>
                  </div>
